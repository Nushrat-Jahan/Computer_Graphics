///4th Level
///PREPARED BY:
///Tonmoy,Md.Reja-E-Rabbi (17-33472-1)
...
void welcomeScreen()
{
    ...
    welcome_text += "1. Use A, S, W, D to control your self.\nA = left\nD = right\nW = up\nS = down\n";
    welcome_text += "2. Use SpaceBar to shoot.\n";
    welcome_text += "3. To avoid collision with enemy , you can either destroy enemy  by shooting it or simply dodging it.\n";
    welcome_text += "4. Shooting the enemy  will give you 20 points, whereas dodging it will give 10 points.\n";
